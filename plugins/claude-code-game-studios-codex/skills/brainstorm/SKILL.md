...
3. **Run through ideation phases** interactively, asking the user questions at
   ...
   **Use a concise plain-text question to the user** at key decision points throughout brainstorming:
   ...
   a concise plain-text question to the user to capture the decision with concise labels.
...
4. **Generate the game concept document** using the template at
   `plugins/claude-code-game-studios-codex/references/templates/game-concept.md`. Fill in ALL sections from the
