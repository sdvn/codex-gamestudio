...
- Use a concise plain-text question to the user to ask:
...
Then use a concise plain-text question to the user to capture feedback:
...
Use a concise plain-text question to the user to ask: "Does this dependency ordering look right? Any
...
Use a concise plain-text question to the user to ask: "Do these priority assignments match your vision?
...
Using the template at `plugins/claude-code-game-studios-codex/references/templates/systems-index.md`, populate the
...
Use a concise plain-text question to the user for: "Start designing [system-name] now, pick a different
system, or stop here?"
...
After `/design-system` completes, use a concise plain-text question to the user:
