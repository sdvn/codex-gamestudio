---
name: game-studio
description: Route requests to the right game-studio workflow in this Codex port. Use when the user needs one entrypoint for planning, setup, implementation teams, reviews, or continuing an existing game project.
---
...
Use this skill as the umbrella entrypoint for the Codex port of Claude Code Game Studios.
